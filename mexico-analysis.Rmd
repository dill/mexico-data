...
- `dsm.var.prop` which takes into account the fact that detection probability may be correlated with the spatial part of the model. It uses methods described in [Bravington, Miller and Hedley, 2019](https://arxiv.org/abs/1807.07996). 
