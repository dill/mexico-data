...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={David L. Miller},
            pdftitle={Example dsm analysis: pantropical dolphins in the Gulf of Mexico},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\NormalTok{sa.tmp <-}\StringTok{ }\KeywordTok{latlong2km}\NormalTok{(survey.area$longitude, survey.area$latitude,}
\DataTypeTok{lon0=}\NormalTok{lon0, }\DataTypeTok{lat0=}\NormalTok{lat0)}

\NormalTok{survey.area <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{x=}\DecValTok{1000}\NormalTok{*sa.tmp$km.e, }\DataTypeTok{y=}\DecValTok{1000}\NormalTok{*sa.tmp$km.n)}
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/areawithtransects.png}
...
\CommentTok{# lm fit}
\NormalTok{l.dat<-}\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{distance=}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{8000}\NormalTok{,}\DataTypeTok{len=}\DecValTok{1000}\NormalTok{))}
\NormalTok{lo<-}\KeywordTok{lm}\NormalTok{(size~distance, }\DataTypeTok{data=}\NormalTok{distdata)}
...
\DataTypeTok{ylab=}\StringTok{"Beaufort sea state"}\NormalTok{, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{, }\DataTypeTok{cex=}\FloatTok{0.5}\NormalTok{, }\DataTypeTok{col=}\KeywordTok{rgb}\NormalTok{(}\FloatTok{0.74}\NormalTok{,}\FloatTok{0.74}\NormalTok{,}\FloatTok{0.74}\NormalTok{,}\FloatTok{0.7}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\begin{figure}[htbp]
\centering
\includegraphics{figure/EDA-plots.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hr.model<-}\KeywordTok{ds}\NormalTok{(distdata,}\KeywordTok{max}\NormalTok{(distdata$distance),}\DataTypeTok{key=}\StringTok{"hr"}\NormalTok{,}\DataTypeTok{adjustment=}\OtherTok{NULL}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/hr-detfct.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod1<-}\KeywordTok{dsm}\NormalTok{(N~}\KeywordTok{s}\NormalTok{(x,y), hr.model$ddf, segdata, obsdata)}
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/mod1-preds.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/mod1-check.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/mod2-preds.png}
...
\includegraphics{figure/mod2-depth.png} Omitting the argument
...
\includegraphics{figure/tweedie-17-residplot.png} Note also the
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/mod4-pred.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hr.beau.model<-}\KeywordTok{ds}\NormalTok{(distdata,}\KeywordTok{max}\NormalTok{(distdata$distance),}
\DataTypeTok{formula=}\NormalTok{~}\KeywordTok{as.factor}\NormalTok{(beaufort),}
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/mod5-pred.png}
...
\NormalTok{mod1.gamm<-}\KeywordTok{dsm}\NormalTok{(N~}\KeywordTok{s}\NormalTok{(x,y), hr.model$ddf, segdata, obsdata,}\DataTypeTok{engine=}\StringTok{"gamm"}\NormalTok{,}\DataTypeTok{correlation=}\KeywordTok{corAR1}\NormalTok{(}\DataTypeTok{form=}\NormalTok{~sg.id),}\DataTypeTok{method=}\StringTok{"REML"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/mod1-gamm-check.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/mod1-gamm-preds.png}
